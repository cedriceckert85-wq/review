...
- **Update 16.06.2026 (22:30, Schluss):** Der Rücksetzer vertiefte sich — RGTI +6,12 %, QBTS +2,97 %, IONQ −1,01 % (unter Einstand), Speku +1,10 %. Vom Mo-Hoch sind es ~−9 % im Lockstep; Speku spülte +4,86 % in zwei Tagen auf +1,10 % zurück. Die >10-%-Messlatte ist in Reichweite, aber auf Einstands-Basis noch nicht gerissen (nur IONQ leicht negativ). Über BEIDE Abwärts-Beine (17:28 + 22:19) erfolgte KEINE Risikomaßnahme (kein Teilverkauf, kein Theme-Cap) — das ist der eigentliche Prozess-Malus, unabhängig vom Ausgang. Das 100-%-Quantum-Buch (jetzt 787 €) amplifiziert die Schwankung in beide Richtungen.
- **Update 17.06.2026 (17:30):** Milder Weiter-Fade (Speku +0,65 %, IONQ −1,78 %, QBTS +1,08 %, RGTI +6,53 %), unverändert 100 % Quantum. Verschärfend: Das Dashboard flaggt 'Automatik-Lauf >24h zurück' — die Entscheidungs-/Scout-Engine steht still, das konzentrierte Buch geht UNbeaufsichtigt in das 20:00-FOMC-Event. Konzentriert + unbeaufsichtigt vor einem Binär-Event ist die ungünstigste Kombination (keine Reaktion auf Stop-Annäherung/Signal möglich). Weiter keine Risikomaßnahme. Drawdown-Test (>10 % aller drei) weiter ausstehend.
...
- **Status:** OFFEN (Round-Trip belegt F-S-001 auf Depot-Ebene; >10-%-Einzel-Drawdown offen; 3. Tag Automatik-/Reporting-Outage = eigenständiges, sich verfestigendes Reliability-Manko — bei Persistenz eigener F-S-Eintrag)
