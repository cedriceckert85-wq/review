...
- **Status:** OFFEN (n=4, alle 4 sofort im Minus — Tendenz SKILL-FEHLER, Messlatte bei n≥8; Wurzel teilt sich mit F-H-004)
...
- **Status:** OFFEN (Messlatte nicht getriggert, aber Near-Miss bleibt als dokumentierter Prozessfehler; Entscheidung Mo 15.06.)
...
| Stop im Rauschen platziert | 1 | F-H-003 | beobachten → Near-Miss dokumentiert, Stop jetzt 3 % entfernt; Entscheidung Mo 15.06. |
