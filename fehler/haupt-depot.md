...
- **Status:** OFFEN — zweigeteilt: Stop-Abstands-Frage ist benigne ausgegangen (kein Schaden, Rauschen-These bestätigt); NEUE Beobachtung Zeit-Exit-Disziplin (Tag 8/7, nicht vollzogen) — am 16.06. mangels frischer Haupt-Daten nicht verifizierbar, weiter verfolgen.
...
| Zeit-Exit nicht eingehalten | 1 | F-H-003 (NVDA Tag 8/7) | NEU 15.06. — eigenes 7-Tage-Limit überschritten, beobachten ob Slip oder dokumentierte Verlängerung |
