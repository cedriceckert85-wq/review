...
- **Status:** ENTSCHEIDUNGSREIF — beide Teile aufgelöst: Stop-Abstand benigne (kein Schaden), Zeit-Exit vollzogen (spät, ~1,8 Pp Kosten = kleiner SKILL-Slip). Im KW25-Wochen-Review formal nach „Erledigte Einträge" verschieben.
...
| Zeit-Exit nicht eingehalten | 1 | F-H-003 (NVDA Tag 9) | 16.06. vollzogen, aber 2 Tage spät (Tag 9 statt 7) → ~1,8 Pp Kosten — kleiner SKILL-Slip, entscheidungsreif für KW25 |
