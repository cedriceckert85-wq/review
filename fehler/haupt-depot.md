...
| **Zeit-Exit nicht eingehalten** | **2 → SKILL-FEHLER** | F-H-003 (NVDA Tag 9; CEG Tag 10/10) | **n=2 = Gewohnheit:** NVDA 16.06. spät vollzogen (~1,8 Pp, folgenlos); CEG 17.06. bei Tag 10/10 NICHT exekutiert → 271→267 zurück (~1,5 % Buchgewinn verschenkt). Abstellen. |
