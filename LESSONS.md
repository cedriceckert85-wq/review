...
| 13.06.2026 (D3) | RGTI bewusst weggelassen — schwächster + korreliertster der drei Quantum-Titel, erhöht Risiko ohne Diversifikation | Fr-Schluss 13.06.: RGTI +7,87 % ist der STÄRKSTE der drei (vor IONQ +2,15 %, QBTS +0,52 %) — Trend läuft gegen die Auslassung | Ausstehend (1-Monats-Messlatte ~11.07.) |
